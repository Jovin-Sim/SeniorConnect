...
function FoodEventScreen({ navigation }) {
  ...
  const fetchEventsRealtime = () => {
    const eventsCollection = collection(db, 'foodEvents');
    ...
    <ScrollView style={styles.container}>
      <View style={styles.gridContainer}>
        ...
        <View style={styles.gridItem}>
            <Text style={styles.gridItemText}>Food</Text>
        </View>
...
export default FoodEventScreen;
