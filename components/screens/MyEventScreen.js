...
function MyEventScreen({ navigation }) {
  ...
  const fetchEventsRealtime = () => {
    const eventsCollection = collection(db, 'userJoinedEvent');
    ...
    <ScrollView style={styles.container}>
      <View style={styles.gridContainer}>
        ...
        <View style={styles.gridItem}>
            <Text style={styles.gridItemText}>My Events</Text>
        </View>
      ...
      <View style={styles.eventSec}>
        {events.map((event) => (
          <TouchableOpacity
            ...
            onPress={() => eventDetailNavigation.navigate('MyEventDetail', { 
          ...
          >
            ...
            <View style={styles.indivEventDesc}>
              ...
              <Text style={styles.indivEventDescText2}>By {event.organizerName}</Text>
            </View>
          </TouchableOpacity>
        ))}
      </View>
